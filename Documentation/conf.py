...
os.environ['PROJECT_NAME'] = 'Nymph'
os.environ['PROJECT_NUMBER'] = this_version
os.environ['PROJECT_BRIEF_DESC'] = 'Flow-Based Data Processing Framework'
...
os.environ['DOXYGEN_INPUT'] = 'DoxFiles ../Library  ../Executables'
...
project = u'Nymph'
copyright = u'2018, Nymph Authors'
...
latex_documents = [
  (master_doc, 'Nymph.tex', u'Nymph Documentation',
...
man_pages = [
    (master_doc, 'nymph', u'Nymph Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Nymph', 'Nymph Documentation',
   author, 'Nymph', 'Data processing framework',
   'Miscellaneous'),
]
