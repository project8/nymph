...
macro( python_package_find_python VALUE )
    execute_process(COMMAND python2.7-config --includes COMMAND awk "{print substr($1,3)}" OUTPUT_VARIABLE PYTHON_INCLUDE_DIR OUTPUT_STRIP_TRAILING_WHITESPACE)
    execute_process(COMMAND python2.7-config --ldflags COMMAND awk "{print substr($1,3)\"/lib\"substr($2,3)}" OUTPUT_VARIABLE PYTHON_LIBRARY_base OUTPUT_STRIP_TRAILING_WHITESPACE)
